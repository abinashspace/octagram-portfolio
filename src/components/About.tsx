...
export function About() {
  return (
    <section id="about" className="relative bg-paper py-24 sm:py-32">
      <Container className="grid gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)] lg:gap-16">
        <SectionHeading
          eyebrow="About Us"
        ...
        <Reveal delay={150} className="flex flex-col gap-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {FOUNDERS.map((founder) => (
              <div key={founder.email} className="rounded-xl border border-border bg-surface p-5">
